...
public class Arista<T extends Comparable<T>>{
    ...
    /**
     * Compara esta arista con otro objeto para determinar su igualdad.
     * Dado que el grafo es no dirigido, dos aristas se consideran iguales si tienen
     * los mismos vértices (sin importar el orden de inicio y fin), el mismo peso
     * y la misma anotación.
     *
     * @param o El objeto a comparar con esta arista.
     * @return {@code true} si el objeto es una Arista con los mismos vértices,
     *         peso y anotación; {@code false} en caso contrario.
     */
    @Override
