...
public class Vertice<T extends Comparable<T>>{
    ...
    /**
     * Compara este vértice con otro objeto para determinar su igualdad.
     * Dos vértices se consideran iguales si sus atributos 'dato' son equivalentes.
     *
     * @param o El objeto a comparar con este vértice.
     * @return {@code true} si los objetos son idénticos o si ambos son vértices
     *         con datos iguales; {@code false} en caso contrario.
     */
    @Override
