...
public class MainABDBDE {
    // Esta prueba es de forma ordenada...
    public static void main(String[] args) {
        ...
        // i. Se añaden todos los números del 0 al 128 uno a uno en orden de menor a mayor (con iteraciones)
        for (int i = 0; i <= 128; i = i+1) {
            arbol.add(new Elemento<>(i));
        }
        ...
        // vi. Obtener el camino al número 110 del árbol ordenado:
